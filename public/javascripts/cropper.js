      ...
      bind: function () {
        ...
        l(e.cropstart) && b(t, it, e.cropstart),
          ...
          e.toggleDragModeOnDblclick &&
            b(i, at, (this.onDblclick = this.dblclick.bind(this))),
    ...
    At = {
      ...
      disable: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.disabled = !0), v(this.cropper, Q)),
          this
        );
      },
      destroy: function () {
      ...
      zoomTo: function (t, e, i) {
        ...
        if (
          ...
          if (
            !1 ===
            y(this.element, rt, { ratio: t, oldRatio: s / d, originalEvent: i })
          )
            return this;
          i
            ? ((t = this.pointers),
              ...
              1 < a &&
                ((this.url = (function (t, e) {
                  for (var i = [], a = new Uint8Array(t); 0 < a.length; )
                    i.push(zt.apply(null, bt(a.subarray(0, 8192)))),
                      (a = a.subarray(8192));
